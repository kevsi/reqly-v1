...
describe("isBlockedIp", () => {
  ...
  it("blocks IPv6 6to4 wrapping a private IPv4 (2002::/16)", () => {
    // 2002:0a00:0001:: = 10.0.0.1 embarqué via 6to4
    expect(isBlockedIp("2002:0a00:0001::")).toBe(true);
    // 2002:c0a8:0101:: = 192.168.1.1
    expect(isBlockedIp("2002:c0a8:0101::")).toBe(true);
    // 2002:0808:0808:: = 8.8.8.8 (public) — bloqué par le prefix /16 quand même
