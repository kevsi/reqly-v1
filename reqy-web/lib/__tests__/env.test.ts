...
describe("lib/env", () => {
  ...
  it("getPublicEnv: falls back to default NEXT_PUBLIC_APP_URL when malformed URL provided", async () => {
  ...
  it("getServerEnv: treats empty or malformed strings in optional URL fields as undefined", async () => {
