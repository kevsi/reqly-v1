...
class FallbackAdapter implements StorageAdapter {
  ...
  async load(key: string): Promise<string | null> {
    try {
      ...
      console.warn("[storage-adapter] load failed, trying secondary:", {
  ...
  async save(key: string, value: string): Promise<void> {
    ...
    try {
      ...
      console.warn("[storage-adapter] save failed on primary:", {
        adapter: this.primary.name,
        error,
      });
    }
    ...
    try {
      ...
      console.warn("[storage-adapter] fallback save succeeded:", {
        primary: this.primary.name,
        secondary: this.secondary.name,
      });
      return;
      ...
      console.error("[storage-adapter] save also failed on secondary:", {
        adapter: this.secondary.name,
        error,
      });
    }
