...
export const MESSAGE_ACTION_BUTTON =
  "flex size-7 items-center justify-center rounded-md opacity-0 group-hover:opacity-100 transition-[opacity,color,background-color] duration-200 text-muted-foreground hover:text-foreground hover:bg-accent";
...
export const TRANSITION_STANDARD = "transition-colors duration-200";
