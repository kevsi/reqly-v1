...
vi.mock("idb", () => {
  function fakeTx() {
    ...
    return {
      objectStore: () => ({
        ...
        put: (value: any) => { store.set(value.key, value); return Promise.resolve(); },
      }),
      done: txDone,
    };
  }
  function fakeDb() {
    return {
      ...
      put: (_s: string, value: any) => { store.set(value.key, value); return Promise.resolve(); },
...
describe("embedding orchestrator", () => {
  ...
  it("returns cached embedding without calling API", async () => {
    store.set("2cf24dba5fb0a30e26e83b2ac5b9e29e1b161e5c1fa7425e73043362938b9824::jina-embeddings-v3", {
